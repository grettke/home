...
<2014-11-06 Thu>
I would like to have a =(gcr/diminish 'button-lock-mode)= call here, but again I
have the load order wrong or something.
...
<2014-11-06 Thu>
I would like to have a =(gcr/diminish 'hs-minor-mode)= call here, but have the
load order wrong or something, so it doesn't work.
...
<2014-11-04 Tue>
Note the =uxo-frames-decision= inclusion, and how there is a newline between the
closing round-bracket. As of today, that bracket disappears during tangling and
it breaks the tangled document. This only seems to occur with when comments and
padding are on.
