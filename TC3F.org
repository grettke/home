...
Not quite sure where this should go yet. Finder is [fn:293] is just fine, and
the curiosuity is still there for an in-Emacs solution. Speedbar [fn:294] and
SrSpeedbar [fn:295] look nice, as does [fn:296].
...
pcase [fn:287] provides pattern-matching macros. This is very nice whether
...
#+name: modes-application-module-all-decision
#+begin_src emacs-lisp
...
block. The example below; thank you [fn:189] Craig Larman
...
enabled. Eric explained that [fn:188] there may be performance gains if some
...
#+end_src
*** Cask  [fn:186]
Install required packages first using Cask [fn:187]. Recently I changed the
...
[fn:188] https://lists.gnu.org/archive/html/emacs-orgmode/2014-06/msg00719.html

[fn:189] http://www.craiglarman.com/wiki/index.php?title=Books_by_Craig_Larman
...
[fn:287] http://www.emacswiki.org/emacs/PatternMatching

[fn:293] https://en.wikipedia.org/wiki/Finder_(software)

[fn:294] http://www.emacswiki.org/emacs/SpeedBar

[fn:295] http://www.emacswiki.org/emacs/SrSpeedbar

[fn:296] https://github.com/jaypei/emacs-neotree
